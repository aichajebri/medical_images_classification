      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-4 border-t border-gray-100">
          ...
          <button
            ...
            className="flex-1 bg-gradient-to-r from-indigo-500 to-cyan-500 text-white py-4 px-6 rounded-xl hover:from-indigo-600 hover:to-cyan-600 transition-all duration-300 font-semibold text-center flex items-center justify-center gap-2 shadow-lg hover:shadow-xl hover:shadow-indigo-500/25"
          >
            <span className="text-xl">🤖</span>
            Ask AI Assistant
          </button>
